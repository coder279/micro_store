...
type CategoryService interface {
	...
	FindCategoryByLevel(ctx context.Context, in *FindByLevelRequest, opts ...client.CallOption) (*CategoryAllResponse, error)
	FindCategoryByParent(ctx context.Context, in *FindByParentRequest, opts ...client.CallOption) (*CategoryAllResponse, error)
	FincAllCategory(ctx context.Context, in *FindAllRequest, opts ...client.CallOption) (*CategoryAllResponse, error)
}
...
func (c *categoryService) FindCategoryByLevel(ctx context.Context, in *FindByLevelRequest, opts ...client.CallOption) (*CategoryAllResponse, error) {
	req := c.c.NewRequest(c.name, "Category.FindCategoryByLevel", in)
	out := new(CategoryAllResponse)
	err := c.c.Call(ctx, req, out, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *categoryService) FindCategoryByParent(ctx context.Context, in *FindByParentRequest, opts ...client.CallOption) (*CategoryAllResponse, error) {
...
func (c *categoryService) FincAllCategory(ctx context.Context, in *FindAllRequest, opts ...client.CallOption) (*CategoryAllResponse, error) {
	req := c.c.NewRequest(c.name, "Category.FincAllCategory", in)
	out := new(CategoryAllResponse)
	err := c.c.Call(ctx, req, out, opts...)
	if err != nil {
		return nil, err
...
type CategoryHandler interface {
	...
	FindCategoryByLevel(context.Context, *FindByLevelRequest, *CategoryAllResponse) error
	FindCategoryByParent(context.Context, *FindByParentRequest, *CategoryAllResponse) error
	FincAllCategory(context.Context, *FindAllRequest, *CategoryAllResponse) error
}
...
func RegisterCategoryHandler(s server.Server, hdlr CategoryHandler, opts ...server.HandlerOption) error {
	type category interface {
		...
		FindCategoryByLevel(ctx context.Context, in *FindByLevelRequest, out *CategoryAllResponse) error
		FindCategoryByParent(ctx context.Context, in *FindByParentRequest, out *CategoryAllResponse) error
		FincAllCategory(ctx context.Context, in *FindAllRequest, out *CategoryAllResponse) error
	}
...
func (h *categoryHandler) FindCategoryByLevel(ctx context.Context, in *FindByLevelRequest, out *CategoryAllResponse) error {
	return h.CategoryHandler.FindCategoryByLevel(ctx, in, out)
}

func (h *categoryHandler) FindCategoryByParent(ctx context.Context, in *FindByParentRequest, out *CategoryAllResponse) error {
	return h.CategoryHandler.FindCategoryByParent(ctx, in, out)
}

func (h *categoryHandler) FincAllCategory(ctx context.Context, in *FindAllRequest, out *CategoryAllResponse) error {
	return h.CategoryHandler.FincAllCategory(ctx, in, out)
}
